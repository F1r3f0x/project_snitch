...
CREATE TABLE IF NOT EXISTS `snitch`.`lista_asistencia` (
  ...
  `cargo_legislativo_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `snitch`.`lista_noticias_fuente`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `snitch`.`lista_noticias_fuente` ;

CREATE TABLE IF NOT EXISTS `snitch`.`lista_noticias_fuente` (
  `fuente_noticias_id` INT NOT NULL,
  `noticia_id` INT NOT NULL,
  PRIMARY KEY (`fuente_noticias_id`, `noticia_id`),
  INDEX `fk_fuente_noticiashasnoticia_noticia1_idx` (`noticia_id` ASC),
  INDEX `fk_fuente_noticiashasnoticia_fuente_noticias1_idx` (`fuente_noticias_id` ASC),
  CONSTRAINT `fk_fuente_noticiashasnoticia_fuente_noticias1`
    FOREIGN KEY (`fuente_noticias_id`)
    REFERENCES `snitch`.`fuente_noticias` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_fuente_noticiashasnoticia_noticia1`
    FOREIGN KEY (`noticia_id`)
    REFERENCES `snitch`.`noticia` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
COMMENT = 'Noticias de una Fuente de noticias.';
