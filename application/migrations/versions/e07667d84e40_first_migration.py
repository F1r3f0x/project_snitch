...
Revision ID: e07667d84e40
Revises: 
Create Date: 2018-06-23 16:56:02.262848
...
def upgrade():
    ...
    sa.Column('fuente_noticias_id', sa.Integer(), nullable=True),
    sa.Column('activo', sa.Boolean(), nullable=False),
    ...
    sa.Column('remuneracion', sa.Float(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['cargo_legislativo_id'], ['cargo_legislativo.id'], ),
    sa.ForeignKeyConstraint(['distrito_id'], ['distrito.id'], ),
    sa.PrimaryKeyConstraint('distrito_id', 'cargo_legislativo_id')
    )
...
def downgrade():
    ...
    op.drop_table('proyecto_siguiendo')
